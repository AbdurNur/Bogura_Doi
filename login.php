                        ...
                        <form class="text-center" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="input-group flex-nowrap mb-4">
                                ...
                                <input type="text" class="form-control" placeholder="Email" name='email' aria-label="email"
                                    aria-describedby="addon-wrapping" value="<?php  if(isset($_SESSION['form_field']['email']) 
                            ...
                            <div class="input-group flex-nowrap mb-4">
                                ...
                                <input type="text" id="password_1" name="password" class="form-control "placeholder="Password" value="<?php   if(isset($_SESSION['form_field']['name']) 

        ...
        <div class="col-md-6">
          ...
          <form class="text-center" action="" method="POST">
            ...
            <div class="input-group flex-nowrap mt-4">
              ...
              <input type="email" id="defaultContactFormAddress" class="form-control" placeholder="example@gmail.com" name="email">
            </div>
            ...
            <div class="input-group flex-nowrap mt-4">
              ...
              <input type="number" id="" class="form-control" placeholder="Number" name="number">
            </div>
            ...
            <div class="input-group flex-nowrap mt-4">
              ...
              <input type="text" id="registration_password" class="form-control" placeholder="Password" name="password">
              <span class="input-group-text" id="addon-wrapping"><i class="fa-solid fa-eye" onclick="myFunction_2()" style="cursor:pointer"></i></span>
            </div>
            ...
            <div class="input-group flex-nowrap mt-4">
              ...
              <input type="text" id="defaultContactFormAddress" class="form-control" placeholder="Address" name="address">
            </div>
            <?php
            ...
            <div class="input-group flex-nowrap mt-4">
              <span class="input-group-text" id="addon-wrapping"><i class="fa-solid fa-location-dot"></i></span>
              <input type="text" id="defaultContactFormAddress" class="form-control" placeholder="Permanent Address" name="permanent_address">
            </div>
